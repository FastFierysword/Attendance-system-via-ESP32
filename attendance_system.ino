...
const char *ssid = "Quantum Spot";
const char *password = "G0dfather";
const char* device_token  = "Device Token";
String getData, Link;
String URL = "https://script.google.com/macros/s/AKfycbxQEGOiCERsipXq6N441_f_mf3BlIqAekQejy_S6tFmJtVMNPX7tKm1OiCOwmbWuK3Y5A/exec";
